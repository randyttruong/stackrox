...
//   - the setting's value, if the flag value is the default value (i.e. flagChanged == false)
//     _and_ the setting's value is non-empty.
//   - the default value, if the flag value is the default value (i.e. flagChanged != false) and the setting's value
//     is empty.
